...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public AndroidxRuntimeLibraryAccessors getRuntime() { return laccForAndroidxRuntimeLibraryAccessors; }
    ...
    public static class AndroidxBenchmarkLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at androidx.benchmark.baseline
         */
        public AndroidxBenchmarkBaselineLibraryAccessors getBaseline() { return laccForAndroidxBenchmarkBaselineLibraryAccessors; }
    ...
    public static class AndroidxBenchmarkBaselineLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at androidx.benchmark.baseline.profile
         */
        public AndroidxBenchmarkBaselineProfileLibraryAccessors getProfile() { return laccForAndroidxBenchmarkBaselineProfileLibraryAccessors; }
    ...
    public static class AndroidxBenchmarkBaselineProfileLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at androidx.benchmark.baseline.profile.gradle
         */
        public AndroidxBenchmarkBaselineProfileGradleLibraryAccessors getGradle() { return laccForAndroidxBenchmarkBaselineProfileGradleLibraryAccessors; }
    ...
    public static class AndroidxBenchmarkBaselineProfileGradleLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxBenchmarkBaselineProfileGradleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for plugin (androidx.benchmark:benchmark-baseline-profile-gradle-plugin)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getPlugin() { return create("androidx.benchmark.baseline.profile.gradle.plugin"); }
    ...
    public static class AndroidxRuntimeLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxRuntimeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getLivedata() { return create("androidx.runtime.livedata"); }
    ...
    public static class MediationLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at mediation.test
         */
        public MediationTestLibraryAccessors getTest() { return laccForMediationTestLibraryAccessors; }
    ...
    public static class MediationTestLibraryAccessors extends SubDependencyFactory {
        ...
        public MediationTestLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for suite (com.google.android.ads:mediation-test-suite)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getSuite() { return create("mediation.test.suite"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: benchmarkBaselineProfileGradlePlugin (1.3.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: mediationTestSuite (3.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: navigationCompose (2.8.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: runtimeLivedata (1.7.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
